...
subtitle: 'Data Wrangling and Experimental Design using Mosquito Data'
graphics: yes
---
...
We will use the Pound Hill dataset collected by students in a Silwood Field Course for understanding some of these  principles. This is not vectorbite data but it is an excellent example of a dataset that needs wrangling. VectorBiTE is too well structured for this sort of wrangling.
...
<img src="../graphics/densTL.png" width="600px">
