...
Now let's do some Bayesian model fitting to *Aedes* thermal performance data. Lets try out the `R2jags` package for this. It wraps the `rjags` package and includes some additional functionalities that make formatting, etc, a bit easier
