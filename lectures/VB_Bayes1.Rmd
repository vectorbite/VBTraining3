...
$$
This has the correct _`r myblue("asymptotic")`_ coverage, but __$y=0$__ is still problematic!
...
where $\theta$ is the success rate of the treatment. Based on this, write down the likelihood for the $n$ patients. Then, assuming a $\mathrm{Beta}(a,b)$ prior for $\theta$ find the posterior distribution for $\theta|Y$. Does this look familiar?
}
```
