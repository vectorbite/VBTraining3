...
## Explore the dataset `lmdataset.csv` that contains values on trait-temperature relationships. Develop a hypothesis and explore the hypothesis using a linear model. Assess your model fit and assumptions.
