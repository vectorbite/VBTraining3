...
|**26°C** | 0.97 - 0.08 = 0.89 | 0.97 - 0.08 + 0.17<span style="color:red"> + 0.01</span> = 1.07|
|**32°C** | 0.97 - 0.15 = 0.82 | 0.97 - 0.15 + 0.17<span style="color:red"> - 0.04</span> = 0.95|
...
## Explore the dataset `lmdataset.csv` thatcontains values on trait-temperature relationships in three important vector/pest species. Develop a hypothesis and explore it using linear models. Assess your model’s fit and assumptions.
