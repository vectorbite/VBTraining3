...
Before we talk about likelihoods, let's review an easy alternative to finding consistent parameters that assumes a probability distribution: `r myblue("method of moments")`. 
...
The likelihood __`r myred("DOES NOT")`__ tell you the probability that parameters have a certain value, given the data. To obtain that quantity, usually called the ``posterior probability of the parameters'' in Bayesian statistics, you have to use Bayes Theorem. 
